<?php /* Template Name: product-detail-Puffy-bites-with-white-cheese */ ?>
        ...
        <main>
            <div class="ProductDetailPage">
                <div class="HeroSection">
                    <div class="PrdImg1"><img class="wow slideInUp" src="https://mccollinsmediaweb.github.io/felis-kitchen/productimages/Thumb/missing.jpg" alt=""></div>
                    <div class="container">
                         <div class="HeroSectionTxt wow slideInUp">Puffy bites with white cheese</div>
                    </div>
                </div>
                <div class="detTab">
                     <div class="container">
                         ...
                         <div id="container">
                             <div class="list" id="one">
                                 ...
                                 <div class="listTxt2 wow slideInUp">Is white your colour? These tasty puffy bites are filled with the yummy flavour of white cheese, perfectly complemented by layers of rich pastry.</div>
                                 <!-- <div class="listTxt3">
