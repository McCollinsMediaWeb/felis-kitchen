<?php /* Template Name: product-detail-Mini-Crepes */ ?>
<?php get_header(); ?>
<header>
           <div class="container">
                <div class="Header">
        ...
        <main>
            <div class="ProductDetailPage">
                <div class="HeroSection">
                    <div class="PrdImg1"><img class="wow slideInUp" src="https://mccollinsmediaweb.github.io/felis-kitchen/productimages/Thumb/Mini Crepes.jpg" alt=""></div>
                    <div class="container">
                         <div class="HeroSectionTxt wow slideInUp">Mini Crepes</div>
                    </div>
                </div>
                <div class="detTab">
                     <div class="container">
                         ...
                         <div id="container">
                             ...
                             <div class="list hide" id="two">
                                 <div class="listTxt1">Mini Crêpe s Plain Baking Instruction</div>
                              ...
                              <div class="list" id="one">
                                 <div class="listTxt2 wow slideInUp">
                                   Fancying a special breakfast today? Then take out our mini crepes!</div>
                                </div>
                             <div class="list hide" id="three">
                                 ...
                                 <div class="listTxt3">
                                     <div class="RedRow wow slideInUp">
                                         <div class="RedIcon"><img src="https://mccollinsmediaweb.github.io/felis-kitchen/assets/images/Group 105.png" alt=""></div>
                                         <div class="RedText">Whole milk, wheat flour, barn eggs, non-hydrogenated rapeseed oil, sugar, salt, raising agent E500ii</div>
                                     </div>
                                     <div class="RedRow wow slideInUp">
                                         <div class="RedIcon"><img src="https://mccollinsmediaweb.github.io/felis-kitchen/assets/images/Group 105.png" alt=""></div>
