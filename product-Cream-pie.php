<?php /* Template Name: product-detail-Cream-pie */ ?>
        ...
        <main>
            <div class="ProductDetailPage">
                <div class="HeroSection">
                    <div class="PrdImg1"><img class="wow slideInUp" src="https://mccollinsmediaweb.github.io/felis-kitchen/productimages/Thumb/12-cream-pie-thumb.jpg" alt=""></div>
                    <div class="container">
                         <div class="HeroSectionTxt wow slideInUp">Cream pie</div>
                    </div>
                </div>
                <div class="detTab">
                     <div class="container">
                         ...
                         <div id="container">
                             <div class="list" id="one">
                                 ...
                                 <div class="listTxt2 wow slideInUp">This is a sweet treat for every sweet tooth, with a mouth-watering cream filling surrounded by a crumbly case. Perfect served with a chat and a cup of tea.</div>
                                 <!-- <div class="listTxt3">
