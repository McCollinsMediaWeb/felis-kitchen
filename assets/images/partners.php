        ...
        <main>
            <div class="OurPartners OurPrtnrPage">
                ...
                <div class="ParnersSlider">
                    <div class="OrTxt1 wow slideInUp align-items-center partPg justify-content-center" style="text-align:center;color:#d50132;margin: bottom 40px;">UAE</div>
                    <div class="container">
            ...
            <div class="InstagramBox">
                ...
                <div class="container text-center  wow slideInUp">
                    <a href="#" class="PrLinkTp2 hover-black">Visit & Follow Us</a>
                </div>
            </div>
