<?php /* Template Name: recipe-Beef-and-Veggie-pies */ ?>
<?php get_header(); ?>
<header>
           <div class="container">
                <div class="Header">
            ...
            <div class="RecipeDetailPage">
                <div class="recipeMain">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="recipeMainTxt1  wow slideInUp">Beef and Veggie pies</div>
                                <div class="recipeMainTxt2  wow slideInUp">Recepie of the month</div>
                                <div class="recipeMainTxt3  wow slideInUp">Delicious beef and vegetable pies that are super easy to make, quick and healthy. Great as a snack and in a fun shape to share at parties or simply amongst the family.</div>
                                <div class="GridDet">
                ...
                <div class="IncredientSection">
                    <div class="container">
                        <div class="row align-item-center">
                            <div class="col-md-4">
                                <div class="icrTxt1  wow slideInUp">Ingrediants</div>
                            </div>
                            <div class="col-md-8">
                                <div class="IncredientRow">
                                    <div class="IncredientRowClm  wow slideInUp">1 tablespoon olive oil </div>
                                    <div class="IncredientRowClm  wow slideInUp">1 brown onion, chopped</div>
                                    <div class="IncredientRowClm  wow slideInUp">1 garlic clove, crushed </div>
                                    <div class="IncredientRowClm  wow slideInUp">500g beef mince </div>
                                    <div class="IncredientRowClm  wow slideInUp">1 1/2 cups frozen mixed vegetables (see note)</div>
                                    <div class="IncredientRowClm  wow slideInUp">2 tablespoons barbecue sauce</div>
                                    <div class="IncredientRowClm  wow slideInUp">2 tablespoons tomato paste</div>
                                    <div class="IncredientRowClm  wow slideInUp"> 8 sheets from Feli's Filo pastry sheet</div>
                                    <div class="IncredientRowClm  wow slideInUp">Olive oil </div>
                                    <div class="IncredientRowClm  wow slideInUp"> cooking spray</div>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="DirectinSection">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="DirectionTxt1 wow slideInUp">Directions</div>
                                <div>
                            ...
                            <div class="col-md-4">
                                <div class="MoreDetRecipe text-center">
                                    <div class="MrTxt1 wow slideInUp">preparation</div>
                                    <div>
                                    ...
                                    <div class="MrTxt1 wow slideInUp">Total TIme</div>
                                    <div>
                                        <div class="IBox1 wow slideInUp">
                                            <div class="IBox1Left">
                                    ...
                                    <div>
                                        <a href="#"  class="IBox1Lnk wow slideInUp hover-black">Back to Recipes</a>
                                    </div>
                                </div>
                            </div>
                        </div>
