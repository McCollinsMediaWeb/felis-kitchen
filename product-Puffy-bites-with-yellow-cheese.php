<?php /* Template Name: product-detail-Puffy-bites-with-yellow-cheese */ ?>
        ...
        <main>
            <div class="ProductDetailPage">
                <div class="HeroSection">
                    <div class="PrdImg1"><img class="wow slideInUp" src="https://mccollinsmediaweb.github.io/felis-kitchen/productimages/Thumb/04-puffy-bites-with-yellow-cheese-thumb.jpg" alt=""></div>
                    <div class="container">
                         <div class="HeroSectionTxt wow slideInUp">Puffy bites with yellow cheese</div>
                    </div>
                </div>
                <div class="detTab">
                     <div class="container">
                         ...
                         <div id="container">
                             <div class="list" id="one">
                                 <div class="listTxt1 wow slideInUp">Details</div>
                                 <div class="listTxt2 wow slideInUp">If you’re more of a yellow fan, step this way. Each fluffy mouthful is jam-packed with the rich taste of yellow cheese, surrounded by delicate buttery pastry.</div>
                                 <!-- <div class="listTxt3">
