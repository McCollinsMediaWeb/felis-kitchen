<?php /* Template Name: product-detail-Protein-Waffles */ ?>
<?php get_header(); ?>
<header>
           <div class="container">
                <div class="Header">
        ...
        <main>
            <div class="ProductDetailPage">
                <div class="HeroSection">
                    <div class="PrdImg1"><img class="wow slideInUp" src="https://mccollinsmediaweb.github.io/felis-kitchen/productimages/Thumb/Protein Waffles.jpg" alt=""></div>
                    <div class="container">
                         <div class="HeroSectionTxt wow slideInUp">Protein Waffles</div>
                    </div>
                </div>
                <div class="detTab">
                     <div class="container">
                         ...
                         <div id="container">
                             ...
                             <div class="list hide" id="two">
                                 <div class="listTxt1">Protein Waffles Baking Instruction</div>
                              ...
                              <div class="list" id="one">
                                 <div class="listTxt2 wow slideInUp">
                                    Make your gym sessions more delicious with a flavorful pre-gym snack, sponsored by our protein waffles!</div>
                                </div>
