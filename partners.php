...
<header>
        ...
        <main>
            <div class="OurPartners OurPrtnrPage">
                <div class="container">
                ...
                <div class="container text-center  wow slideInUp">
                    <button type="button" class="btn btn-primary PrLinkTp2 hover-black" data-toggle="modal" data-target="#exampleModal">Be A Partner</button>


                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" style="margin-top:50px;">
                        <div class="modal-content" style="background:#d50132;">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel" style="color:#fff">Be A Partner</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color:#fff;opacity:1;">
                            <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                        <?php echo do_shortcode( '[contact-form-7 id="98" title="Partner Enquiry"]' ); ?>
                        </div>
