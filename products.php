                    ...
                    <div class="BgTras">
                        <div class="container">
                           <div class="OurProductBox text-center">
                                <div class="OrTxt1 wow slideInUp">Our Products</div>
                                <div class="OrTxt2 wow slideInUp">
                                    Super-fast, super-yummy meals
                                </div>
                                <div class="OrTxt3 wow slideInUp">
                                    Feli’s Kitchen pastries are a quick and convenient way to serve up tasty food for your family.<br/>
                                    We freeze them to lock in flavour and freshness, so every mouthful is scrumptious when it reaches your dinner table. <br/>
                                    And with 20 varieties to choose from, we’re sure even little tums will be satisfied.<br/>
                                    You can even experiment with your own flavours with our do-it-yourself pastry sheets.
                                </div>
                           </div>
                           <div>
                               <div class="HorMenu1">
                                   <div class="HorMenu1Row">
                                       <a href="javascript:void(0)" class="active  wow slideInUp group1Click">All Products</a>
                                       <a href="javascript:void(0)" class=" wow slideInUp group2Click">A Frozen Savory Range</a>
                                       <a href="javascript:void(0)" class=" wow slideInUp group3Click">A Frozen Sweet Range</a>
                                       <!-- <a href="javascript:void(0)" class=" wow slideInUp group4Click">A ‘do it yourself’ Raw Dough Range</a> -->
                                   </div>
                               </div>
                           </div>
