<?php /* Template Name: product-detail-Puff-pastry-dough */ ?>
        ...
        <main>
            <div class="ProductDetailPage">
                <div class="HeroSection">
                    <div class="PrdImg1"><img class="wow slideInUp" src="https://mccollinsmediaweb.github.io/felis-kitchen/productimages/Thumb/15-pastery-dough-thumb.jpg" alt=""></div>
                    <div class="container">
                         <div class="HeroSectionTxt wow slideInUp">Puff pastry dough</div>
                    </div>
                </div>
                <div class="detTab">
                     <div class="container">
                         ...
                         <div id="container">
                             <div class="list" id="one">
                                 ...
                                 <div class="listTxt2 wow slideInUp">When you’re craving light, flaky, puffy bites, choose our puff pastry dough. It’s a super speedy shortcut to delicious pastry delights.</div>
                                 <!-- <div class="listTxt3">
