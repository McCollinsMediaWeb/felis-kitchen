<?php /* Template Name: product-detail-Plain-Crepe */ ?>
<?php get_header(); ?>
<header>
           <div class="container">
                <div class="Header">
        ...
        <main>
            <div class="ProductDetailPage">
                <div class="HeroSection">
                    <div class="PrdImg1"><img class="wow slideInUp" src="https://mccollinsmediaweb.github.io/felis-kitchen/productimages/Thumb/Plain Crepe.jpg" alt=""></div>
                    <div class="container">
                         <div class="HeroSectionTxt wow slideInUp">Plain Crepe</div>
                    </div>
                </div>
                <div class="detTab">
                     <div class="container">
                         ...
                         <div id="container">
                             ...
                             <div class="list hide" id="two">
                                 <div class="listTxt1">Crêpes Plain Baking Instruction</div>
                              ...
                              <div class="list" id="one">
                                 <div class="listTxt2 wow slideInUp">
                                    Enjoy a plain crepe for your breakfast that’s very simple to make!</div>
                                </div>
