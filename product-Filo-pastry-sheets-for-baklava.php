<?php /* Template Name: product-detail-Filo-pastry-sheets-for-baklava */ ?>
        ...
        <main>
            <div class="ProductDetailPage">
                <div class="HeroSection">
                    <div class="PrdImg1"><img class="wow slideInUp" src="https://mccollinsmediaweb.github.io/felis-kitchen/productimages/Thumb/14-filo-baklava-thumb.jpg" alt=""></div>
                    <div class="container">
                         <div class="HeroSectionTxt wow slideInUp">Filo pastry sheets for baklava</div>
                    </div>
                </div>
                <div class="detTab">
                     <div class="container">
                         ...
                         <div id="container">
                             <div class="list" id="one">
                                 ...
                                 <div class="listTxt2 wow slideInUp">This rich, sweet pastry is perfect for special occasions or a weekend treat. All you need to do is add your own family-recipe filling.</div>
                                 <!-- <div class="listTxt3">
