<?php /* Template Name: product-detail-Cheese-Spring-Roll */ ?>
<?php get_header(); ?>
<header>
           <div class="container">
                <div class="Header">
        ...
        <main>
            <div class="ProductDetailPage">
                <div class="HeroSection">
                    <div class="PrdImg1"><img class="wow slideInUp" src="https://mccollinsmediaweb.github.io/felis-kitchen/productimages/Thumb/Cheese Spring Roll.jpg" alt=""></div>
                    <div class="container">
                         <div class="HeroSectionTxt wow slideInUp">Cheese Spring Roll</div>
                    </div>
                </div>
                <div class="detTab">
                     <div class="container">
                         ...
                         <div id="container">
                             ...
                             <div class="list hide" id="two">
                                 <div class="listTxt1">Cheese Spring Roll Baking Instruction</div>
                                 <div class="listTxt3 wow slideInUp">
                                     <div class="RedRow wow slideInUp">
                                         ...
                                         <div class="RedText">Remove the Cheese Rolls from the refrigerator for 5 minutes before frying.</div>
                                     </div>
                                     <div class="RedRow wow slideInUp">
                                         <div class="RedIcon"><img src="https://mccollinsmediaweb.github.io/felis-kitchen/assets/images/Group 105.png" alt=""></div>
                                         <div class="RedText">Fry in vegetable oil at 180°C for 3-4 minutes.</div>
                                     </div>
                                     <div class="RedRow wow slideInUp">
                                         <div class="RedIcon"><img src="https://mccollinsmediaweb.github.io/felis-kitchen/assets/images/Group 105.png" alt=""></div>
                                         <div class="RedText">Adjust the frying time and temperature depending on your stove.</div>
                                     </div>
                                     <div class="RedRow wow slideInUp">
                                         <div class="RedIcon"><img src="https://mccollinsmediaweb.github.io/felis-kitchen/assets/images/Group 105.png" alt=""></div>
                                         <div class="RedText">You will know it is ready once the Cheese Rolls pieces are golden brown.</div>
                                     </div>
                                 </div> 
                             </div>
                              <div class="list" id="one">
                                 <div class="listTxt2 wow slideInUp">
                                    As cheesy as it can be, enjoy our delicious and healthy cheese spring rolls!</div>
                                </div>
                             <div class="list hide" id="three">
                                 ...
                                 <div class="listTxt3">
                                     <div class="RedRow wow slideInUp">
                                         <div class="RedIcon"><img src="https://mccollinsmediaweb.github.io/felis-kitchen/assets/images/Group 105.png" alt=""></div>
                                         <div class="RedText">Flour, butter, water, mozzarella cheese, feta cheese, parsley, onion.</div>
                                     </div>
                                     <div class="RedRow wow slideInUp">
                                         <div class="RedIcon"><img src="https://mccollinsmediaweb.github.io/felis-kitchen/assets/images/Group 105.png" alt=""></div>
                                         <div class="RedText">Contains wheat (gluten), and dairy products (including lactose).</div>
                                     </div>
                                 </div> 
                             </div>
                         </div>   
