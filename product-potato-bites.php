<?php /* Template Name: product-detail-Potato-bites */ ?>
<?php get_header(); ?>
<header>
           <div class="container">
                <div class="Header">
        ...
        <main>
            <div class="ProductDetailPage">
                <div class="HeroSection">
                    <div class="PrdImg1"><img class="wow slideInUp" src="https://mccollinsmediaweb.github.io/felis-kitchen/productimages/Thumb/potato-bites.jpg" alt=""></div>
                    <div class="container">
                         <div class="HeroSectionTxt wow slideInUp">Potato Bites</div>
                    </div>
                </div>
                <div class="detTab">
                     <div class="container">
                         ...
                         <div id="container">
                             ...
                             <div class="list hide" id="two">
                                 <div class="listTxt1">Potato Bites Baking Instruction</div>
                              ...
                              <div class="list" id="one">
                                 <div class="listTxt2 wow slideInUp">
                                    Who doesn’t love potato? Here’s our ode to potatoes!</div>
                                </div>
                             <div class="list hide" id="three">
                                 ...
                                 <div class="listTxt3">
                                     <div class="RedRow wow slideInUp">
                                         <div class="RedIcon"><img src="https://mccollinsmediaweb.github.io/felis-kitchen/assets/images/Group 105.png" alt=""></div>
                                         <div class="RedText">Dough: wheat flour, water, refined vegetable oils (sunflower, palm, rapeseed and cottonseed) in varying proportions, corn starch, salt, humectant: glycerol; sugar, dough conditioner [wheat gluten, flour treatment agent: ascorbic acid; enzymes, wheat flour, wheat starch, corn starch], flavoring, flour treatment agent: L cysteine.</div>
                                     </div>
                                     <div class="RedRow wow slideInUp">
                                         <div class="RedIcon"><img src="https://mccollinsmediaweb.github.io/felis-kitchen/assets/images/Group 105.png" alt=""></div>
                                         <div class="RedText">Filling: water, dehydrated potato flakes (20%), potatoes (7%), onion, sunflower oil, salt, spices.</div>
                                     </div>
                                     <div class="RedRow wow slideInUp">
                                         <div class="RedIcon"><img src="https://mccollinsmediaweb.github.io/felis-kitchen/assets/images/Group 105.png" alt=""></div>
                                         <div class="RedText">Contains wheat.</div>
                                     </div>
                                 </div> 
                             </div>
                         </div>   
