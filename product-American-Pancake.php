<?php /* Template Name: product-detail-American-Pancake */ ?>
<?php get_header(); ?>
<header>
           <div class="container">
                <div class="Header">
                     ...
                     <div class="container">
                         ...
                         <div id="container">
                             ...
                             <div class="list hide" id="two">
                                 <div class="listTxt1">American Pancake Baking Instruction</div>
                              ...
                              <div class="list" id="one">
                                 <div class="listTxt2 wow slideInUp">
                                    Heavily filling and absolutely delicious, try out our American pancakes today! </div>
                                </div>
